...
def setup_package():
    ...
    metadata = dict(
        name="corrxor",
        version=VERSION,
        description="Benchmark for correlation using xor",
...
def configuration(parent_package="", top_path=None):
    ...
    config = Configuration("corrxor_directory", parent_package, top_path)
    config.add_extension(
        "corrxor", ["corrxor/alg/src/dsp.c", "corrxor/alg/src/main.c"],
        extra_info=info)
